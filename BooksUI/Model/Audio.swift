...
extension Audio {
    static let MOCK_AUDIOS = [
        Audio(name: "The Power Of NOW", author: "Eckhart Tolle", image: "audio5", progress: 1.0, formattedDuration: "8:07:50", formattedProgress: "8:07:50"),
    ...
    static let CURRENT_AUDIO =  Audio.MOCK_AUDIOS[0]
}
